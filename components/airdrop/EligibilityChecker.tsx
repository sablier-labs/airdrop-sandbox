...
import { useMerkleRoot } from "@/lib/hooks/useMerkleRoot";
import { useTokenInfo } from "@/lib/hooks/useTokenInfo";
import { formatAddressDisplay, isValidAddressOrEns, useEnsResolution } from "@/lib/utils/ens";
      ...
      <CardContent className="space-y-4">
        ...
        {isMerkleRootLoading && (
          <div className="text-center text-sm text-muted-foreground">
            📡 Fetching Merkle root from contract...
          </div>
        )}
